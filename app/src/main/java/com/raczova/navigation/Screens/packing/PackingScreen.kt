...
import com.raczova.navigation.Screen
import com.raczova.navigation.models.packing.TripModel
import com.raczova.navigation.route
                            ...
                            Column(modifier = Modifier.padding(8.dp)) {
                                Row(
                                    ...
                                    Icon(
                                        ...
                                        contentDescription = stringResource(id = com.raczova.navigation.R.string.remove_trip),
                                        tint = OurPackingBlue,
                                        modifier = Modifier
                                            .padding(8.dp)
                                            .clickable {
                                ...
                                Text(
                                    text = stringResource(id = com.raczova.navigation.R.string.packing_percentage)+packingPercentage+"%",
                                    color = OurPackingBlue,
                                    fontSize = 18.sp,
        ...
        AlertDialog(
            ...
            dismissButton = {
                TextButton(onClick = {
                    ...
                    Text(stringResource(id = com.raczova.navigation.R.string.cancel_button), fontSize = 16.sp)
                }
            }
        )
    }
